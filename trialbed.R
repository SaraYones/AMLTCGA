...
CNVfile=read.table(file="/Users/sarayones/Downloads/TCGA_LAML/CNV/broad.mit.edu_LAML.Genome_Wide_SNP_6.Level_3/TCGA_AB_2877_03A_01D_0756_21.hg19.seg.txt",header = T,sep="\t")
...
write.table(merged,file = "/Users/sarayones/Desktop/CNVAnnotated.bed",sep = "\t",quote = F,col.names = T, row.names = F)
...
bedr::bed2vcf(CNVfile,file = "/Users/sarayones/Desktop/Projects/output1.bed",zero.based = FALSE, header = NULL, fasta = "/Users/sarayones/Desktop/Projects/AMLProject/hg38.fa")
is.valid.region(
  CNVfile,
  check.zero.based = TRUE,
  check.chr = TRUE,
